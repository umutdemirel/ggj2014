...
local function loadScreen ()
	...
	rostak = nil
	rostak = display.newImage("GGJ14_Level3_1.png")
	...
	option1Button = nil
	option1Button = display.newImage("GGJ14_Level3_2.png")
	...
	option2Button = nil
	option2Button = display.newImage("GGJ14_Level3_3.png")
	...
	option3Button = nil
	option3Button = display.newImage("GGJ14_Level3_4.png")
...
function GameLevel3Screen.addButtonEventListeners ()
...
menuInCompleted = function (obj)
	GameLevel3Screen.addButtonEventListeners()
end

function GameLevel3Screen.playSound()
end

function GameLevel3Screen.menuIn ()
	GameLevel3Screen.playSound()
...
function GameLevel3Screen.removeButtonEventListeners ()
