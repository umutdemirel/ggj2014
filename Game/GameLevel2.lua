...
local function loadScreen ()
	...
	gameLevelBarImage_Sprite.y = display.contentHeight * 0.37
	...
	rostak = nil
	rostak = display.newImage("GGJ14_Level2_1.png")
	...
	option1Button = nil
	option1Button = display.newImage("GGJ14_Level2_2.png")
	option1Button:setReferencePoint(display.CenterReferencePoint)
	option1Button.x = display.contentWidth * 0.75
	option1Button.y = display.contentHeight * 0.55
	...
	option2Button = nil
	option2Button = display.newImage("GGJ14_Level2_3.png")
	option2Button:setReferencePoint(display.CenterReferencePoint)
	option2Button.x = display.contentWidth * 0.25
	...
	option3Button = nil
	option3Button = display.newImage("GGJ14_Level2_4.png")
	option3Button:setReferencePoint(display.CenterReferencePoint)
	option3Button.x = display.contentWidth * 0.75
	option3Button.y = display.contentHeight * 0.81
...
function GameLevel2Screen.addButtonEventListeners ()
...
menuInCompleted = function (obj)
	GameLevel2Screen.addButtonEventListeners()
end

function GameLevel2Screen.playSound()
end

function GameLevel2Screen.menuIn ()
	GameLevel2Screen.playSound()
...
function GameLevel2Screen.removeButtonEventListeners ()
